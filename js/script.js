...
function submitClicked() {
  ...
  if (id<10) {
    ...
    id++
    document.getElementById('question').innerHTML = '<img src="' + question[id].images + '" alt="pokemon" height="50%" width="50%"/>'
  }
  else {
    document.getElementById('all').innerHTML = '<h4> you got: </h4> <h4>' + points + '/11 </h4>'
    if (points < 6) {
      document.getElementById('endimg').innerHTML = '<img src="./images/pikachusleeppokeball.gif " alt="pokemon" height="50%" width="50%"/> <h5> want to retry?</h5>'
    }
    else {
      document.getElementById('endimg').innerHTML = '<img src="./images/pikachupokeball.gif" alt="pokemon" height="50%" width="50%"/> <h5> want to retry?</h5>'
    }
    document.getElementById('returnbutton').innerHTML = '<a href="./index.html"> <buttonclass="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent"> retry</button></a>'
    start = true
  }
